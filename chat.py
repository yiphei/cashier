...
def is_on_topic(model, TM, current_node_schema, all_node_schemas):
    ...
    prompt = (
        ...
        "</state>\n\n"
        "The tools represent explicit actions that the model can perform.\n"
        "<tools>\n"
        ...
        " last customer message can be fully handled by the current AI agent's <instructions>, <state>, or <tools> in accordance with the guidelines defined in <guidelines>. Return true if"
