...
class BaseTest:
    ...
    def build_transition_turns(self,
                               agent_executor,
                               model_provider,
                               is_stream,
                               fn_calls,
        ...
        t2 = self.add_user_turn(
            agent_executor, user_msg, model_provider
        )
        ...
        node_turn_2 = TurnArgs(
            turn=NodeSystemTurn(
                msg_content=next_node_schema.node_system_prompt(
                    ...
                    node_input_json_schema=next_node_schema.input_schema.model_json_schema() if next_node_schema.input_schema is not None else None,
