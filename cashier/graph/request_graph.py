...
class RequestGraphSchema:
    def __init__(self, graph_schemas, system_prompt):
        ...
        self.graph_schema_id_to_graph_schema = {graph_schema.id: graph_schema for graph_schema in self.graph_schemas}
...
class RequestGraph:
    ...
    def get_graph_schemas(self, request):
        ...
        for agent_selection in agent_selections:
            self.graph_schema_sequence.append(self.schema.graph_schema_id_to_graph_schema[agent_selection.agent_id])
            self.tasks.append(agent_selection.task)
            self.graph_schema_id_to_task[agent_selection.agent_id] = agent_selection.task
